...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      home: MyHomePage( title: "Ibrahim Shaglil Project",),
    );
  }
}
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ElevatedButton(
                onPressed: () {
                  Get.to(() => NewtonMethodPage());
                },
                child: Text("Newton Method")),
            SizedBox(height: 32,),
            ElevatedButton(
                onPressed: () {
                  Get.to(() => LeastSquareWithNormalEquationPointsPage());
                },
                child: Text("Least Square"))
          ],
        ),
      ),
